...
/***********************++++++++++测试环境配置+++++++++*********************/
return [
	'cookDomain' => 'tooarts.com',
	'website' => 15,
	'client'  => 24,
	'page'    =>1,
	'pageSize'=>10,
	'imagesCdnUrl' => 'http://img.tooarts.com',
	'imagesHasClip' => false, //图片是否有裁剪 true 会在域名中加入clip
	'cartHost'   => 'http://cartuat.tooarts.com',
	'cartCookiesName' => 'plist',
	'staticRoute'     =>'http://staticuat.tooarts.com/tooarts',
	'copyRight' => 'Copyright © 2016 tooarts INC. All Rights Reserved.',
	'langPrefix' => 'tooarts', //语言前缀
	...
	'productDetailSmallImgHeight' =>  120, //商品详情页放大镜小图高度
	'productDetailSmallImgWidth' =>  120, //商品详情页放大镜小图宽度
