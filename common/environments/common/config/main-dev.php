...
return [
    ...
    'components' => [
        ...
        'reqApi' => [//接口管理
            ...
            'sites' => [//API站点
                'baseApi' => ['host' => 'http://base.api.tomtop.com', 'ip' => '52.39.119.62'],
                'memberApi' => ['host' => 'http://member.api.tomtop.com', 'ip' => '52.39.119.62'],
                'productApi' => ['host' => 'http://product.api.tomtop.com', 'ip' => '52.39.119.62'],
                'loyaltyApi' => ['host' => 'http://loyalty.api.tomtop.com', 'ip' => '52.39.119.62'],
                'cartApi' => ['host' => 'http://cart.tomtop.com'],
                'shippingApi' => ['host' => 'http://logistics.api.tomtop.com', 'ip' => '52.39.119.62'],
                'advertApi' => ['host' => 'http://advert.api.tomtop.com', 'ip' => '52.39.119.62'],
                'ttApi' => ['host' => 'http://www.tomtop.com', 'ip' => '52.39.119.62']
            ],
            'apis' => [//各种API
                //baseApi
                'getCountries' => [//获取国家接口
