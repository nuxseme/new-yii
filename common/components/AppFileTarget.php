...
{   
    ...
    public function init()
    {
        ...
        {
            $this->baseLogDir = Yii::$app->getRuntimePath() . DS . 'logs' . DS . Yii::$app->id . DS;
        }
        else
        {
        ...
        $this->_logDir === null && $this->_logDir = $this->baseLogDir . date('Ym') . DS . date('d') . DS;
    ...
    protected function clearFiles()
    {
        ...
        if(($dh = @opendir($this->baseLogDir)) !== false)
        {
            ...
            {
                $realFile = $this->baseLogDir . DS . $file;
