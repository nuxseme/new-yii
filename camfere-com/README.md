...
server {
    ...
    #服务器名
    server_name dev.camfere.com;
    root        E:/work3/webroot/camfere-com/web; #根据个人情况进行更改
    index       index.php;

    #日志文件
    access_log  E:/logs/camfere.com-access.log;#根据个人情况进行更改
    error_log   E:/logs/camfere.com-error.log;#根据个人情况进行更改
    ...
    #虚拟目录
    location ~ /camfere/.*\.(js|css|jpg|png|jpeg|gif|bmp|ico|font|swf|flv|ttf|woff|woff2|svg|eot)(.*) {#根据个人情况进行更改
...
```
127.0.0.1       dev.camfere.com #根据实际情况进行更改
```
