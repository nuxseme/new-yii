    ...
    <div class="accountRight accouReviewBox lineBlock">
        ...
        <ul class="myReviewsList lbUl">
            <li class="headPortrait">
                <div><img src="<?= (empty($accountBaseInfo['cimageurl'])) ?  $TTHelper->staticPrefix().'/icon/HeadPic.jpg' : $accountBaseInfo['cimageurl']?>"></div>
            ...
            <li>
                <ol>CAMFERE points: <b><?=$reviewStatistical['pointsTotal'];?></b></ol>
            </li>
        </ul>
