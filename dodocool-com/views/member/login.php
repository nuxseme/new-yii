      ...
      <div class="col_5">
        ...
        <div class="login_box">
          <form>
              ...
              <div class="rembMe">
                 <a class="forget_psw" href="<?=Url::toRoute('member/forgetpass');?>">Forgot Your Password</a>
...
Dodocool services such as</h3>
         ...
         <p><a href="<?=Url::toRoute('member/index');?>">Create Your Dodocool Account</a>Dont have an account yet?</p>
        </div>
      </div>
   </div>
    </div>
