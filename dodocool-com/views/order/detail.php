...
$this->title ='My Order';
AppAsset::register($this, 'detail-order');
		      ...
		      <tr>
		        <td colspan="6">
		            <ul class="cartListUL oneS">
		                ...
		                <li class="cartListLI">
		                    <a class="inBlock pro_img" href="<?= $TTHelper::urlRewrite($item['curl'],'product')?>"><img alt="<?= $item['ctitle']?>" src="<?= $TTHelper::getThumbnailUrl('product',$item['cimageurl'],72,72);?>"></a>
