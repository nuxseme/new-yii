...
<section class="contentInside">
		...
		<ul class="lbUl writeReviewWarp">
			<li class="writeLeft">
				...
				<p class="writePrice">Sale Price: <span><?=$basic['symbol']?><?=$basic['nowprice'];?></span></p>
				<h5>Average Customer Review</h5>
				<div class="averageWarp">
					<div class="bigReviews lineBlock">
				        <div class="bigStar" style="width:<?=$basic['stars']['overall']*20?>%"> </div>
				    </div>
				    <b class="lineBlock fon18"><?=$basic['stars']['overall']?></b>
					<p>based on <?=$reviewCount;?>Customer Review</p>
				</div>
