...
class BaseController  extends AppController
{
	...
	*/
	public function beforeAction($action)
	{
		...
		{//只有非ajax请求才有layout
			Yii::$app->view->params['nav'] = $this->runAppAction('\common\actions\ppheader\NavAction');
			Yii::$app->view->params['footerArticle'] = $this->runAppAction('\common\actions\ppheader\FooterArticleAction');
