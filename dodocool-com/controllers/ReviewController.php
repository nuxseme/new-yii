...
class ReviewController extends BaseController
{
    ...
    public function actionIndex()
    {
        ...
        //评论统计
        $reviewStatus = $this->_model->reviewStatus(['uuid' => $uuid, 'email' => $this->_email]);
        //用户基本信息
        $userBasicInfo = Yii::createObject('common\models\Account')->getUserBasicInfo(['email' => $this->_email])['data'];
...
//        }
    ...
    public function actionProductreviews()
    {
        ...
        if($listingId) 
        {
            ...
            $result = Yii::createObject('common\models\Review')->getProductReviews($listingId, $page, $pageSize);
    ...
    { 
        ...
        if (!empty($product)) 
        {
            ...
            $data['basic'] = [
                ...
                'sku'       => $basic['sku'],
                'title'     => $basic['title'],
                'nowprice'  => $basic['nowprice'],
                'origprice' => $basic['origprice'],
                'symbol' => $basic['symbol'],
            ];
